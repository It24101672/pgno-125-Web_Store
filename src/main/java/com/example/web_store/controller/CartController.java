...
public class CartController {
    ...
    public ResponseEntity<CartItem> addToCart(@RequestBody CartItem cartItem) {
        ...
        Optional<com.example.web_store.model.Product> productOptional = productRepository.findById(cartItem.getProductId());
        if (!productOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
        }

        com.example.web_store.model.Product product = productOptional.get();
    ...
    public ResponseEntity<CartItem> updateCartItem(@PathVariable String id, @RequestBody CartItem updatedItem) {
        ...
        Optional<com.example.web_store.model.Product> productOptional = productRepository.findById(updatedItem.getProductId());
        if (!productOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
        }
